...
# Consider all supported coins unless a specific
# coin is provided as the first command line argument
if len(sys.argv) == 1:
    
    [collect_prices(i) for i in config['SUPPORTED_COINS']]
